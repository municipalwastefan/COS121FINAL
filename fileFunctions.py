...
'''
Initiate
Parameters: The file given by the user
Returns: the list of data in dictionaries as the variable allPpl
...
Returns: List of field names of the csv file
...
'''
createPerson
Parameters: One line of csv data, split into a list by commas
Returns: A dictionary containing the data of that one line of data
...
'''
dataSearch
Parameters: The field being searched through, the input being searched by, and the list of data
Returns: Nothing
...
'''
idRemove
Parameters: The id that the user wants to remove the data for, and the list of data
Returns: updated list of data with the indicated line removed
...
'''
dataAdd
Parameters: The new data information created by the user, and the prexisting list of data
Returns: the list of data, now with the new line added
This function adds a new line of data to the end of the csv data. In main(), a list containing the given input for each
key:value pair is created. (Note: the id is automatically the next id after the very end of the prexisting data.)
That list is given to this function, where it is turned into a dictionary for the new line of data.
Once it is created, it is appended to the end of the full data and that updated variable is returned.
'''
